...
{
  px4_msgs__msg__VehicleRatesSetpoint * msg = (px4_msgs__msg__VehicleRatesSetpoint *)malloc(sizeof(px4_msgs__msg__VehicleRatesSetpoint));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleRatesSetpoint__Sequence__init(px4_msgs__msg__VehicleRatesSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleRatesSetpoint *)calloc(size, sizeof(px4_msgs__msg__VehicleRatesSetpoint));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleRatesSetpoint__Sequence * array = (px4_msgs__msg__VehicleRatesSetpoint__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleRatesSetpoint__Sequence));
  if (!array) {
    return NULL;
  }
